...
NOTE: After you write your code, test it out manually by running `ruby trip.rb` in the command line. If the program does what you want it to, you're good to go and can use `git` to save your work!
